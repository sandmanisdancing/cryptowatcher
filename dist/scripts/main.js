...
var app = new Vue({
  ...
  methods: {
    ...
    createInvestment: function createInvestment(e) {
      ...
      if (this.myInvestments.length) {
        ...
        var elementExists = this.myInvestments.some(function (item) {
          return item["id"] === _this.investTemplate.id;
        });

        // and if it is - write new data into investment entry
        if (elementExists) {
          this.myInvestments.forEach(function (item, index) {
            if (item["id"] === _this.investTemplate.id) {
              Object.assign(item, _this.investTemplate);
            }
          });
        } else {
    ...
    createTransaction: function createTransaction() {
      ...
      this.myInvestments.forEach(function (item, index) {
        if (item["id"] === _this2.investTemplate.id) {
          item["coinsWithdraw"] += _this2.investTemplate["coinsWithdrawTemp"];
          item["usdWithdraw"] += _this2.investTemplate["usdWithdrawTemp"];
        }
      });
    ...
    clearInvestTemplate: function clearInvestTemplate(e) {
      this.investTemplate["id"] = null, this.investTemplate["cryptoInvestedAmount"] = 0, this.investTemplate["cryptoInvestedSymbol"] = "Crypto name", this.investTemplate["usdInvested"] = null, this.investTemplate["coinsAmount"] = 0, this.investTemplate["coinsSymbol"] = null, this.investTemplate["finishDate"] = null, this.investTemplate["url"] = null, this.investTemplate["usdWithdraw"] = 0, this.investTemplate["coinsWithdraw"] = 0, this.investTemplate["usdWithdrawTemp"] = 0, this.investTemplate["coinsWithdrawTemp"] = 0;
    },
    ...
    makeTransaction: function makeTransaction(index) {
      for (key in this.myInvestments[index]) {
        this.investTemplate[key] = this.myInvestments[index][key];
      }
    ...
    closeWindow: function closeWindow(popup, e) {
    ...
    highlightRow: function highlightRow(index) {
      ...
      var rows = document.querySelectorAll('.table--myinv tbody tr:nth-child(' + index + ')');
  ...
  computed: {
    ...
    filteredInvestments: function filteredInvestments() {
      var self = this;
